                                ...
                                classes.map((selected_class, index) => (
                                    <div key={index} className="mx-4 mb-8 w-full flex justify-center items-center flex-col">
                                        ...
                                        {selected_class.lessons.map((lesson, lessonIndex) => (
                                            <a key={lessonIndex} href={`/lessons/${lesson._id}`} className="mb-2 inline-block w-full max-w-2xl px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-[#09a6a3] hover:bg-emerald-950">
