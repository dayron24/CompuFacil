                    ...
                    (questions.length <= 0) ? (
                        ...
                        <>
                            ...
                            {questions.map((question, index) => (
                                <div key={index} className="p-5 max-w-screen-sm w-100 h-auto p-5 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex">
